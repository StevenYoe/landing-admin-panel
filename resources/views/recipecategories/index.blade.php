...
@section('title', 'Kategori Resep - Pazar Website Admin')

@section('page-title', 'Kategori Resep')

@section('content')

    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-xl font-semibold">Daftar Kategori Resep</h2>
    ...
    <x-card>
        ...
        @else
            <div class="py-8 text-center">
                <p class="text-gray-400">Belum ada kategori resep yang ditambahkan</p>
