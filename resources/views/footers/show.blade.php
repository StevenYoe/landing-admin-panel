<!--
    Footer Details Page
    This Blade view displays detailed information about a single footer entry.
    It provides options to go back to the list, edit, or delete the footer.
...
@section('content')
    ...
    <div class="mb-6 flex justify-between items-center">
        <!-- Button to return to the footer list -->
        ...
        <div class="flex justify-center space-x-2">
            ...
            <!-- Form to delete the footer with confirmation -->
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div class="lg:col-span-2">
            <!-- Card displaying footer's basic information -->
            ...
            <!-- Card displaying footer labels and descriptions in different languages -->
        ...
        <div class="lg:col-span-1">
            <!-- Card displaying the footer icon if available -->
            <x-card title="Icon">
