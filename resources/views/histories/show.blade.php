...
@section('title', 'Detail History - Pazar Website Admin')
...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex justify-center space-x-2">
            ...
            <form action="{{ route('histories.destroy', $history['hs_id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus history ini?');">
                @csrf
                @method('DELETE')
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div class="lg:col-span-2">
            <x-card title="Informasi History">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-gray-400">Tahun</h4>
                        <p>{{ $history['hs_year'] }}</p>
                    </div>
                </div>
            </x-card>
