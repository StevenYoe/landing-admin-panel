...
@section('page-title', 'Why Pazar')

@section('content')

    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-xl font-semibold">Daftar Why Pazar</h2>
    ...
    <x-card>
        @if(count($whyPazars) > 0)
            ...
            <x-table 
                :headers="[
                    ['name' => 'ID', 'key' => 'w_id'],
                    ['name' => 'Title (ID)', 'key' => 'w_title_id'],
                    ['name' => 'Title (EN)', 'key' => 'w_title_en'],
                    ['name' => 'Description (ID)', 'key' => 'w_description_id'],
                    ['name' => 'Description (EN)', 'key' => 'w_description_en'],
                    ['name' => 'Image', 'key' => 'w_image']
                ]"
                :sortBy="$sortBy"
                :sortOrder="$sortOrder"
            >
                    ...
                    <tr class="border-b dark:border-gray-700 hover:bg-gray-600">
                        ...
                        <td class="px-5 py-4 text-center">
                            <div class="flex justify-center space-x-2">
                                ...
                                <form action="{{ route('whypazars.destroy', $whyPazar['w_id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus why pazar ini?');">
                                    @csrf
                                    @method('DELETE')
        ...
        @else
            <div class="py-8 text-center">
                <p class="text-gray-400">Belum ada why pazar yang ditambahkan</p>
