...
@section('title', 'Detail Company Profile - Pazar Website Admin')

@section('page-title', 'Detail Company Profile')
...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex justify-center space-x-2">
            ...
            <form action="{{ route('companyprofiles.destroy', $companyProfile['cp_id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus company profile ini?');">
                @csrf
                @method('DELETE')
    ...
    <div class="grid grid-cols-1 gap-6">
        <x-card title="Informasi Company Profile">
