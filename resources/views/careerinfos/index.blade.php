...
@endphp
    ...
    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-xl font-semibold">Daftar Career Info</h2>
        @if($hasWriteAccess)
    ...
    <x-card>
                    ...
                    <tr class="border-b dark:border-gray-700 hover:bg-gray-600">
                        ...
                        <td class="px-5 py-4 text-center">
                            <div class="flex justify-center space-x-2">
                                ...
                                <form action="{{ route('careerinfos.destroy', $careerInfo['ci_id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus career info ini?');">
                                    @csrf
                                    @method('DELETE')
        ...
        @else
            <div class="py-8 text-center">
                <p class="text-gray-400">Belum ada career info yang ditambahkan</p>
                @if($hasWriteAccess)
