...
@section('title', 'Detail Career Info - Pazar Website Admin')

@section('page-title', 'Detail Career Info')
...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex justify-center space-x-2">
            ...
            <form action="{{ route('careerinfos.destroy', $careerInfo['ci_id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus item ini?');">
                @csrf
                @method('DELETE')
        ...
        <div class="lg:col-span-1">
            <x-card title="Gambar">
                @if(!empty($careerInfo['ci_image']))
                    <div class="mb-4">
                        <img src="{{ $careerInfo['ci_image'] }}" alt="{{ $careerInfo['ci_title_id'] }}" class="w-full rounded-md">
                    </div>
                @else
