...
@section('page-title', 'Career Info Details')
        ...
        <div class="lg:col-span-2">
            ...
            <x-card title="Career Info Titles & Descriptions" class="mt-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-gray-400 mb-2">Title (Inggris)</h4>
                        <p>{{ $careerInfo['ci_title_en'] }}</p>
                        
                        <h4 class="text-sm font-medium text-gray-400 mt-4 mb-2">Description (Inggris)</h4>
