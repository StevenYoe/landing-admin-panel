<aside 
    ...
    @php
        ...
        $hasHRAccess = app('App\Http\Controllers\BaseController')->hasHRAccess();
        $hasContentAccess = app('App\Http\Controllers\BaseController')->hasContentAccess();
        $hasWriteAccess = app('App\Http\Controllers\BaseController')->hasWriteAccess();
        $isSuperAdmin = app('App\Http\Controllers\BaseController')->isSuperAdmin();
        $canViewContentMenus = app('App\Http\Controllers\BaseController')->canViewContentMenus();
        $canViewHRMenus = app('App\Http\Controllers\BaseController')->canViewHRMenus();
    @endphp
    ...
    <div class="sidebar-content">
        <nav class="p-4 space-y-2 overflow-y-auto h-full">
            ...
            <!-- HR Management - Show only for HR and superadmin -->
            @if($canViewHRMenus)
