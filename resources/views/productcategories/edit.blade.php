...
@section('title', 'Edit Kategori Produk - Pazar Website Admin')
    ...
    <x-card>
        <form action="{{ route('productcategories.update', $category['pc_id']) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                <label for="pc_image" class="block text-sm font-medium mb-2">Gambar Kategori</label>
                    ...
                    @if(!empty($category['pc_image']))
                        <div class="mt-2">
                            <p class="text-sm text-gray-400 mb-2">Gambar Kategori Saat Ini:</p>
